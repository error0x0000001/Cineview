          ...
          <div className='flex items-center w-full '>
            <input
              ...
              className='w-[calc(100%-100px)] md:w-[calc(100%-150px)] h-[50px] md:h-[60px] text-black bg-white px-[15px] md:px-[30px] 
                       rounded-l-[15px] text-[14px] md:text-[20px] outline-none border-none font-medium'
            ...
            <button
              ...
              className="w-[100px] md:w-[150px] h-[50px] md:h-[60px] text-white rounded-r-[15px] text-[16px] md:text-[18px] outline-none border-none search_btn_gradient"
            >
              Search
            </button>
          </div>
